"""
main.py  -- MediTrack entry point (the program you actually run).

    python3 main.py            -> interactive menu
    python3 main.py --demo     -> runs an automated demo of every feature
"""
...
# ------------------------------------------------------------------ #
#  Automated demo -- exercises every module at once
# ------------------------------------------------------------------ #
def run_demo():
