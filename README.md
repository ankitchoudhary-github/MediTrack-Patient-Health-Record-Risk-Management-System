...
A **console-based healthcare application** built using ONLY the Python concepts. No external libraries, no classes/OOP— just core Python, functions, data structures, functional tools, generators, recursion, packages and the standard library.
...
1. Store patient records (name, DOB, gender, blood group, allergies, vitals).

2. Automatically compute **BMI**, **blood-pressure stage** and an overall

**health-risk score** for each patient.

3. Search patients, add new patients and log visits.

4. Produce reports: high-risk patients, average age, all allergies on file.

5. Show the hospital's department hierarchy and generate appointment slots.
